...
//!
//! To see it in action, go to the [demo crate](https://docs.rs/aquamarine-demo-crate/0.1.6/aquamarine_demo_crate/fn.example.html) docs.rs page.
//!
//! ### Dark-mode
//! 
...
//! ```
//!
//! [Demo on docs.rs](https://docs.rs/aquamarine-demo-crate/0.1.6/aquamarine_demo_crate/fn.example_with_styling.html)
//!
